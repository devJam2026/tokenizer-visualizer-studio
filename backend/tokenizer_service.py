...
class TokenizerService:
    ...
    def analyze_text_heuristics(self, text: str) -> str:
        """
        Compiles a high-quality local rule-based tokenomics report.
        Allows diagnostics to remain fully active when offline or without an OpenAI Key.
        """
        if not text:
        ...
        # Construct beautiful local profiling report
        report = []
        ...
        # 2. Token Inflation script checks
